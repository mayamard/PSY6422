...
```{r final plot static, warning=FALSE}
...
I'm quite proud of my plot! It is a relatively simple plot but I learned a lot, and felt a sense of accomplishment when my ideas worked out. I really enjoyed adding in the small details with html and seeing it all come together.
...
gov.uk collection on net dwelling supply & confirmation of this being financial year data: 
...
Colour palette hex codes & guidance from ONS: 
> https://service-manual.ons.gov.uk/data-visualisation/colours/using-colours-in-charts#standard-category-colour-palette
